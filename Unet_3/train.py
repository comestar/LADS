...
if __name__ == "__main__":
    ...
    model_path = r"D:\Project\Model\unet-pytorch\logs\last_epoch_weights.pth"
    #-----------------------------------------------------#
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "LADS_Voc/ImageSets/Segmentation/train.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "LADS_Voc/ImageSets/Segmentation/val.txt"),"r") as f:
